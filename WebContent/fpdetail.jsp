...
<c:import url="./view/topmenu.jsp"/>
   ...
   <tr>
      ...
      <button onclick="location.href='./fplist'"class="btn btn-outline-primary">발자국</button>
      <button onclick="location.href='./fpupdateForm?footPrintNO=${footprint.footPrintNO}'" class="btn btn-outline-primary">발자국 수정</button>
      <button onclick="location.href='./fpdel?footPrintNO=${footprint.footPrintNO}'"class="btn btn-outline-primary">발자국 삭제</button>
