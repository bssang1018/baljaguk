...
<c:import url="./view/topmenu.jsp"/>
  ...
  <a href="./noticewriteForm.jsp" class="list-group-item list-group-item-action list-group-item-light" >글쓰기</a>  
      </c:if>
</div>
...
<h2> 공지사항 목록</h2>
	...
	<div class="col-md-6 mb-2" style="float: none; margin:0 auto;">
		<form class="d-inline-flex justify-content-end" style="height: 25px;" action="noticesearch" method="post">
