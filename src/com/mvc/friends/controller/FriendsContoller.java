...
@WebServlet({"/friendsBlockList", "/friendsAddOverlay", "/friendsAdd", "/friendsDel", "/friendsList", "/friendsBlock", "/friendsBlockCancle", "/friendsRecomend"})
public class FriendsContoller extends HttpServlet {
	...
	private void dual(HttpServletRequest req, HttpServletResponse resp)  throws ServletException, IOException {
		...
		/*
		 * case ("/friendsRecomend"): System.out.println("친구 추천 리스트 요청...");
		 * //loginemail = "test@test"; req.setAttribute("recomendList",
		 * service.friendsRecomend(loginemail)); req.setAttribute("loginemail",
		 * loginemail); dis = req.getRequestDispatcher("friendsTest.jsp");
		 * dis.forward(req, resp); break;
		 */
